...
object MongoDBUtils {
    private fun getClientSettings(): MongoClientSettings {
        val user = System.getenv("db.mongo.user")
        val password = System.getenv("db.mongo.password")
        val appName = System.getenv("db.mongo.appname")
        val host = System.getenv("db.mongo.host") ?: "127.0.0.1"
        val port = System.getenv("db.mongo.port") ?: "27017"
        val maxPoolSize = System.getenv("db.mongo.maxPoolSize")?.toInt() ?: 20
    ...
    private val client = MongoClient.create(getClientSettings()).co
